...
if(isset($_POST['displayContribution'])){
	...
	$displayQuery = mysqli_query($con, 'SELECT * FROM contribution_records ORDER BY id DESC');
...
if(isset($_POST['totalContribution'])){
	$countContributionsQuery = mysqli_query($con, "SELECT SUM(annualMembershipFee+monthlyContribution+voluntaryContribution+specialContribution) FROM contribution_summary WHERE name = '".$_SESSION['name']."'");
