        ...
        function (require, module, exports) {
              ...
              t.forEach((t, i) => {
                ...
                o.data.forEach((e, s) => {
                  (i = e.cloneNode(!1)),
                    ...
                    t.forEach((t) => {
                      (r = e.cells[t].cloneNode(!0)),
                        (r.data = e.cells[t].data),
                        i.appendChild(r),
                        o.hiddenColumns.includes(t) ||
                          ((r = e.cells[t].cloneNode(!0)),
                          (r.data = e.cells[t].data),
          ...
          class o {
            ...
            render(t) {
              ...
              const a = e("table", { class: "dataTable-pagination" }),
                  ...
                  if ("txt" === o.type || "csv" === o.type) {
                    for (r = "", n = 0; n < i.length; n++) {
                      for (h = 0; h < i[n].cells.length; h++)
                        if (
                          !o.skipColumn.includes(s[h].originalCellIndex) &&
                          this.columns(s[h].originalCellIndex).visible()
                        ) {
                          ...
                          (t = t.trim()),
                            ...
                            (t = t.replace(/#/g, "%23")),
                            t.includes(",") && (t = `"${t}"`),
                            (r += t + o.columnDelimiter);
                        }
                      (r = r.trim().substring(0, r.length - 1)),
                        (r += o.lineDelimiter);
                    }
                    (r = r.trim().substring(0, r.length - 1)),
                      o.download && (r = `data:text/csv;charset=utf-8,${r}`);
                  } else if ("sql" === o.type) {
                    for (
                      r = `INSERT INTO \`${o.tableName}\` (`, n = 0;
                      n < s.length;
                      n++
                    )
                    ...
                    for (
                      ...
                      for (r += "(", h = 0; h < i[n].cells.length; h++)
                        !o.skipColumn.includes(s[h].originalCellIndex) &&
                          this.columns(s[h].originalCellIndex).visible() &&
                          (r += `"${i[n].cells[h].textContent}",`);
                      (r = r.trim().substring(0, r.length - 1)), (r += "),");
                    }
                    (r = r.trim().substring(0, r.length - 1)),
                      (r += ";"),
                      o.download &&
                        (r = `data:application/sql;charset=utf-8,${r}`);
                  } else if ("json" === o.type) {
                    for (h = 0; h < i.length; h++)
                      for (a[h] = a[h] || {}, n = 0; n < s.length; n++)
                        !o.skipColumn.includes(s[n].originalCellIndex) &&
                          this.columns(s[n].originalCellIndex).visible() &&
                          (a[h][s[n].textContent] = i[h].cells[n].textContent);
                    (r = JSON.stringify(a, o.replacer, o.space)),
                      o.download &&
                        (r = `data:application/json;charset=utf-8,${r}`);
                  }
                  return (
                    o.download &&
            ...
            import(e) {
              ...
              if (i.data.length || t(i.data)) {
                if ("csv" === i.type) {
                  ...
                  t.length &&
                    (i.headings &&
                      ((s.headings = t[0].split(i.columnDelimiter)), t.shift()),
                    t.forEach((t, e) => {
                      s.data[e] = [];
            ...
            print() {
              const t = this.activeHeadings,
                ...
                h = e("tr");
              t.forEach((t) => {
                h.appendChild(e("th", { html: t.textContent }));
              }),
                a.appendChild(h),
                s.forEach((t) => {
                  const s = e("tr");
