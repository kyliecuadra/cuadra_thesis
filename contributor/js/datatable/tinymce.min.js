...
!(function () {
  ...
  function tn(e) {
    var r = void 0 === e ? window : e,
      ...
      o = Jt(Nt.fromDom(t)),
      n = void 0 === r ? window : r;
    return (dt().browser.isFirefox()
      ? ve.none()
      : ve.from(n.visualViewport)
    ).fold(
      function () {
  ...
  (ci = aa.support = {}),
              ...
              Di(e, function (e) {
                return t.test(
                  ("string" == typeof e.className && e.className) ||
                    (typeof e.getAttribute != Pi && e.getAttribute("class")) ||
                    ""
                );
              }))
          );
    ...
    (pi = aa.select = function (e, t, n, r) {
      ...
      return (
        (c || gi(e, l))(r, t, !wi, n, (ra.test(e) && fa(t.parentNode)) || t), n
      );
    }),
    ...
    var n,
      ...
      v = function (t) {
        ...
        if (
          (p &&
            !n &&
            ((r = f(t)), (o = t.parentNode), !r && V(o) && ml(g) && f(o)),
          g.deep && i.length)
        ) {
      ...
      h = function (e, t) {
        ...
        if (
          ...
          if (o) {
            ...
            var i = c();
            if (
              ((e = s.fire("SetSelectionRange", { range: e, forward: t })
                .range),
              i)
            ) {
              f = e;
  ...
  function PC(e) {
    ...
    return (
      ...
      (c = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = e),
          F0([{ keyCode: Bf.SPACEBAR, action: M0(BC, c) }], t).each(function (
            e
          ) {
            t.preventDefault();
          }));
          ...
          t.destroyed ||
            (n || t.removed
              ? (n ||
                ...
                i.selection &&
                  (i.selection = i.selection.win = i.selection.dom = i.selection.dom.doc = null),
                (t.destroyed = !0))
              : t.remove());
      }),
