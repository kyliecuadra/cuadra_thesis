...
<body>
		...
		<ul class="nav-links">
			...
			<li>
				<a href="contributionSummary.php">
					<i class="fa-solid fa-clipboard" style="color:#00FFF3;"><img src="../assets/icons/clipboard-solid.svg" style="height: 24px; filter: invert(1);"></i>
	...
	<section class=" home-section">
		<nav class="container-fluid">
			...
			<div class="btn-group">
				<span class="name d-flex flex-column"><?php echo $_SESSION['name']; ?><span style="font-size: 15px;">CONTRIBUTOR</span></span>
			...
			<div class="row g3 my-3">
				...
				<div class="col-md-6 overview">
					<div class="p-3 bg-light shadow-sm d-flex justify-content-around align-items-center rounded">
						<div>
							<h3 class="fs-2">
								<?php $countContributionsQuery  = mysqli_query($con, 'SELECT SUM(Annual_Membership_Fee+Monthly_Contribution+Voluntary_Contribution+Special_Contribution) FROM contribution_summary WHERE name = "'.$_SESSION['name'].'"');
		...
		<div class="member-tab-header px-4">
		</div>
		<div class="px-4">
